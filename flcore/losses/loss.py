...
def get_loss_module(args):
    ...
    if task == "regression" or task == "long_term_forecast":
        return nn.MSELoss(reduction='mean')  # outputs loss for each batch sample
...
class MaskedMSELoss(nn.Module):
    """ 
    Masked MSE Loss for Unsupervised Pre-training
    """
